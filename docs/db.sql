...
CREATE TABLE `study`.`sys_permission` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `url` VARCHAR(128) NOT NULL,
  PRIMARY KEY (`id`));

CREATE TABLE `study`.`sys_role_permission` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `role_id` INT NOT NULL,
  `permission_id` INT NOT NULL,
  PRIMARY KEY (`id`));

INSERT INTO `study`.`sys_permission` (`url`) VALUES ('/');
INSERT INTO `study`.`sys_permission` (`url`) VALUES ('/admin/home');

INSERT INTO `study`.`sys_role_permission` (`role_id`, `permission_id`) VALUES ('1', '1');
INSERT INTO `study`.`sys_role_permission` (`role_id`, `permission_id`) VALUES ('1', '2');
INSERT INTO `study`.`sys_role_permission` (`role_id`, `permission_id`) VALUES ('2', '1');
